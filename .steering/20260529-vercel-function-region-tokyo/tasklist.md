...
- [x] P1. 関心事ごとにコミット分割:
  - コミット 1: ステアリングファイル追加 (12232ec)
  - コミット 2: 実装 (vercel.json) + ドキュメント (architecture.md) (64f74d6)
  - コミット 3: ステアリング進捗 + 振り返り (d551e5f)
- [x] P2. PR タイトル: `Vercel 関数のリージョンを東京 (hnd1) に固定 (#46 案 #4)`
- [x] P3. PR 本文: `Closes #150` / `Relates to #46`、設計概要 / 計測予定を記載 (PR #151)
